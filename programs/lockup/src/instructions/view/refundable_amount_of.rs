...
use crate::{
    ...
    utils::{constants::*, lockup_math::get_refundable_amount},
};

#[derive(Accounts)]
#[instruction(stream_id: u64)]
pub struct RefundableAmountOf<'info> {
    #[account(
...
pub fn handler(ctx: Context<RefundableAmountOf>, _stream_id: u64) -> Result<u64> {

...
describe("createWithTimestampsLt", () => {
  ...
  describe("when the program is initialized", () => {
    ...
    describe("given deposit amount is zero", () => {
      it("should fail", async () => {
        // When all tranche amounts are zero, deposit_amount = 0, which triggers DepositAmountZero
        await expectToThrow(
    ...
    describe("given empty tranches array", () => {
      it("should fail", async () => {
        // Empty tranches array means deposit_amount = 0, which triggers DepositAmountZero first
        await expectToThrow(
          ctx.createWithTimestampsLt({
            tranches: [],
          }),

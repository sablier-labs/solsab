use crate::{fuzz_accounts::FuzzAccounts, instructions::*};
...
pub struct WithdrawalFeeInLamportsTransaction {
    pub instruction: WithdrawalFeeInLamportsInstruction,
}
...
impl TransactionHooks for WithdrawalFeeInLamportsTransaction {
